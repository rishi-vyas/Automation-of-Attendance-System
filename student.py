...
class Student:
    def __init__(self,root):
        ...
        left_img=Image.open(r"img\help.jpg")
        ...
        left_label.place(x=5,y=0,width=720,height=130)

        #currentcourseinformation
        current_course_information=LabelFrame(left_frame,bd=2,bg="white",relief=RIDGE,text="Current Course information",font=("times new roman",13,"bold"))
        current_course_information.place(x=5,y=135,width=720,height=150)

        #department 
        dep_label=Label(current_course_information,text="Department",font=("times new roman",13,"bold"),bg="white")
        dep_label.grid(row=0,column=0,padx=2,pady=10,sticky=W)

        dep_combo=ttk.Combobox(current_course_information,textvariable=self.var_dept,font=("times new roman",13,"bold"),state="read only",width=20)
        ...
        #year
        year_label=Label(current_course_information,text="Year",font=("times new roman",13,"bold"),bg="white")
        year_label.grid(row=1,column=0,padx=2,sticky=W)

        year_combo=ttk.Combobox(current_course_information,textvariable=self.var_year,font=("times new roman",13,"bold"),state="read only",width=20)
        year_combo["values"]=("Select year","2020-21","2021-22","2022-23","2023-24")
        year_combo.current(0)
        year_combo.grid(row=1,column=1,padx=2,pady=10,sticky=W)

        #semester
        sem_label=Label(current_course_information,text="Semester",font=("times new roman",13,"bold"),bg="white")
        sem_label.grid(row=1,column=2,padx=2,sticky=W)

        sem_combo=ttk.Combobox(current_course_information,textvariable=self.var_sem,font=("times new roman",13,"bold"),state="read only",width=20)
        ...
        #studentid
        student_id=Label(class_Student_frame,text="StudentID",font=("times new roman",13,"bold"),bg="white")
        ...
        #studentname
        student_name=Label(class_Student_frame,text="Student Name:",font=("times new roman",13,"bold"),bg="white")
        ...
        #classdivision
        class_division=Label(class_Student_frame,text="Class Division:",font=("times new roman",13,"bold"),bg="white")
        ...
        #phoneno
        phone_no=Label(class_Student_frame,text="Phone No:",font=("times new roman",13,"bold"),bg="white")
        ...
        address_Entry=ttk.Entry(class_Student_frame,textvariable=self.var_add,width=20,font=("times new roman",13,"bold"))
        address_Entry.grid(row=4,column=1,padx=10,pady=5,sticky=W)

        #Teachersname
        teacher=Label(class_Student_frame,text="Teachers Name:",font=("times new roman",13,"bold"),bg="white")
        ...
        button_frame1.place(x=0,y=200,width=715,height=70)
        ...
        button_frame2.place(x=0,y=235,width=715,height=35)

        take_photo_button=Button(button_frame2,text="Take Photo Sample",command=self.generate_dataset,width=35,cursor="hand2",font=("times new roman",13,"bold"),bg="blue",fg="white")
        take_photo_button.grid(row=0,column=0)

        update_photo_button=Button(button_frame2,text="Update Photo Sample",width=35,cursor="hand2",font=("times new roman",13,"bold"),bg="blue",fg="white")
        ...
        right_label.place(x=5,y=0,width=720,height=130)

        #================ Searching System ==================#

        search_frame=LabelFrame(Right_frame,bd=2,bg="white",relief=RIDGE,text="Searching System",font=("times new roman",13,"bold"))
        search_frame.place(x=5,y=135,width=710,height=70)

        #search by
        search=Label(search_frame,text="Search By:",font=("times new roman",13,"bold"),bg="red",fg="white")
        ...
        search_combo["values"]=("Select","Roll No","Phone No","3 Sem","4 Sem")
        ...
        search_button=Button(search_frame,text="Search",width=12,cursor="hand2",font=("times new roman",12,"bold"),bg="blue",fg="white")
        search_button.grid(row=0,column=3,padx=4)

        selectAll_button=Button(search_frame,text="Show All",width=12,cursor="hand2",font=("times new roman",12,"bold"),bg="blue",fg="white")
        selectAll_button.grid(row=0,column=4,padx=2)
...
#functiondec
    def add_data(self):
        if self.var_dept.get()=="Select Department" or self.var_std_name.get()=="" or self.var_USN.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="alwayswin@11",database="attendance_database_students")
                my_cursor=conn.cursor()   #query is executed using cursor
...
#================ Generate Data Set Or Take Photo Sample =====================
 ...
 #Load Predefined Data On Face Frontal From cv2
                ...
                while True:
                    ...
                    if cv2.waitKey(1)==5 or int(img_id)==12: #it was 13 and 100 before 
                        break
                cap.release()
