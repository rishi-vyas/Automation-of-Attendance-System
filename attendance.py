...
class Attendance:
    def __init__(self,root):
        ...
        #first image
        img0=Image.open(r"img\ct.jpg")                               #add here image path
        img0=img0.resize((800,200),Image.ANTIALIAS)
        ...
        #second image
        img1=Image.open(r"img\bw.jpg")                               #add here image path
        ...
        #bg image
        img3=Image.open(r"img\IMG_20200802_125333.jpg")              #add here bg image path
        ...
        img_left=Image.open(r"img\3idiots.jpg")                                          #add here bg image path
