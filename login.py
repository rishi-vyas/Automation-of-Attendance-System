...
class Login_Window:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(file=r"img\hogwards.jpg")
        ...
        img1 = Image.open(r"img\338157.jpg")
        ...
        # ========================= Icon Images ==========================
        img1p = Image.open(r"img\338157.jpg")
        ...
        img2 = Image.open(r"img\338157.jpg")
        ...
        forgetpassbtn = Button(frame, text="Forget Password", command=self.forget_password_window, font=("times new roman", 10, "bold"), borderwidth=0, relief=RIDGE, fg="white", bg="black", activeforeground="white", activebackground="black")
    ...
    def login(self):
        if self.txtuser.get() == "" or self.txtpass.get() == "":
            ...
            conn = mysql.connector.connect(
                host="localhost", user="root", password="alwayswin@11", database="attendance_database_students")
    ...
    def reset_pass(self):
        if self.combo_security_Q.get() == "Select":
            ...
            conn = mysql.connector.connect(host="localhost", user="root", password="alwayswin@11", database="attendance_database_students")
            my_cursor = conn.cursor()
...
#         # ===============bg image================
#         self.bg = ImageTk.PhotoImage(file=r"img\nature-wallpaper.png")
#         bg_lbl = Label(self.root, image=self.bg)
#         bg_lbl.place(x=0, y=0, relwidth=1, relheight=1)

#         # ===============left image================
#         self.bg1 = ImageTk.PhotoImage(file=r"img\hogwards.jpg")
...
#         # =================buttons=========================
#         img0 = Image.open(r"img\register-now-button.png")
#         img0 = img0.resize((200, 50), Image.ANTIALIAS)
...
#         img1l = Image.open(r"img\loginbutton.png")
